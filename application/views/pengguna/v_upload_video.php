...
<div class="col-lg-12 mt-5">
    <div class="card">
        <div class="card-header">
            <strong class="card-title">Tambahkan Video</strong>
        </div>
	            ...
	            <div class="card-body">
                	...
                	<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                		...
                		<div class="form-group has-success">
                            <label for="cc-name" class="control-label mb-1">Judul video</label>
		                ...
		                <div class="col-lg-12 mt-5">
						    <div class="card">
						        <div class="card-header">
						            <strong class="card-title">Tambah Video Tutorial</strong>
						        </div>
							        ...
							        <div id="pay-invoice">
							            <div class="card-body">
										    ...
										    <div class="row form-group">
                                                <div class="col-12 mt-4"><textarea name="textarea-input" id="textarea-input" rows="4" placeholder="Masukan deskripsi dari video" class="form-control"></textarea></div>
                                            </div>
