<link rel="stylesheet" href="<?= base_url('assets/style_css/'); ?>template/body_auth.css">
            ...
            <div class="row no-gutters">
              ...
              <div class="col-md-12">
                <div class="card-body">
                  ...
                  <p><a href="<?= base_url('auth/logout'); ?>">Keluar</a></p>
                  <hr>
                  <p class="card-text"><small class="text-muted">friends | komunitas | <a href="#">Member since <?= date('d F Y', $user['date_created']); ?></a></small></p>
                </div>
              </div>
            </div>
          </div>
